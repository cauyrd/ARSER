...
- Tips:
    ...
    for Windows, OS X or Redhat is an excellent choice that ¡°just works¡± out of the box. 
    Another excellent alternative for Windows users is Python (x, y).
    
Usage
=====
- Command-line running: 
      usage: python arser.py input_file_name output_file_name
...
<Input>: Microarray data file with a header line which records the time-points . 
...
Citations
=======================
Rendong Yang and Zhen Su, Analyzing circadian expression data by harmonic regression based on autoregressive spectral estimation Bioinformatics. 2010 Jun 15;26(12):i168-74.
